...
if(current_url(true)->getSegment(2) =='edit'){
    ?>
    <input type="hidden" name="param" id="param" value="<?php echo $edit_pinjam['kd_buku'];?>">
    <?php
}
?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kembali" id="kembali" value="<?php echo empty(set_value('kembali')) ? (empty($edit_pinjam['kembali']) ? "":$edit_pinjam['kembali']) : set_value('kembali') ; ?>" class="form-control">
                    </div>
                    <div class="form-group">
